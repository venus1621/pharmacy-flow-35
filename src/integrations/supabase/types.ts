// Supabase types removed. The project no longer uses Supabase.
// Replace any imports that relied on these types with the app's backend types in `src/types` or `services/backendApi`.
